Vue.component('left-side-menu', {
    ...
    <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 599px;"><div class="slimscroll-menu" style="overflow: hidden; width: auto; height: 599px;">
    ...
    </div><div class="slimScrollBar" style="background: rgb(158, 165, 171); width: 8px; position: absolute; top: -799.53px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 246.768px;"></div><div class="slimScrollRail" style="width: 8px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div></div>
    <!-- Sidebar -left -->
